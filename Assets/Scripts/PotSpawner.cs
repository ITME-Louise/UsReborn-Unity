...
public class PotSpawner : MonoBehaviour
{
    ...
    {
        GameObject pot1 = Instantiate(flowerVaseStage1, spawnPosition, Quaternion.identity);
        Debug.Log("1단계 화분 생성");
        yield return new WaitForSeconds(10f);

        Destroy(pot1);
        GameObject pot2 = Instantiate(flowerVaseStage2, spawnPosition, Quaternion.identity);
        Debug.Log("2단계 화분 생성");
        yield return new WaitForSeconds(10f);

        Destroy(pot2);
        GameObject pot3 = Instantiate(flowerVaseStage3, spawnPosition, Quaternion.identity);
        Debug.Log("3단계 화분 생성");
        yield return new WaitForSeconds(10f);
